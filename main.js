//Options
const CLIENT_ID = '453325109491-s2ruhkl5csslqc359ivamu4291hug813.apps.googleusercontent.com'
...
const defaultChannel='kkiirriillll1'
...
function getChannel(channel){
    ...
    .catch(err=>{alert('No channel by the name')})
}
//add commas
    ...
    request.execute(response =>{
        ...
        if(playlistItems){
            ...
            playlistItems.forEach(item=>{
                const videoId = iten.snippet.resourceId.videoId;
                output+=`
                <div class = "col s3"
